class Solution(object):
    def leastInterval(self, tasks, n):
        ...
        total = 0
        while not done:
            keys = [x[0] for x in sorted(st.items(), key=lambda x: x[1], reverse=True)]
            ans = []
            for i in keys:
                if i in st:
                    ans.append(i)
...
# print Solution().leastInterval(["A","B","B","B","B","B"], 2) #B,A,i,B,i,i,B,i,i,B,i,i,B
# print Solution().leastInterval(["A","A","B","B","B","B","B"], 2) #B,A,i,B,i,i,B,i,i,B,i,i,B
